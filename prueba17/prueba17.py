...
# Función para duplicar un archivo Excel y filtrar duplicados excepto en la columna 6
def excel_intermedio(original_file):
    try:
        ...
        filtrar_valores_repetidos(new_file_path)

    except Exception as e:
        print(f'Ocurrió un error al guardar el Excel Intermedio')

# Función para filtrar duplicados excepto en la columna 6 de un archivo Excel
def filtrar_valores_repetidos(file_path):
    try:
       # Cargar el archivo Excel copiado
        ...
        # Iterar sobre cada celda de cada columna (excepto la columna 6)
        ...
        os.system(file_path)  # Esto abrirá el archivo con el programa predeterminado

    except Exception as e:
        print(f'Ocurrió un error al filtrar los duplicados')
        raise e
