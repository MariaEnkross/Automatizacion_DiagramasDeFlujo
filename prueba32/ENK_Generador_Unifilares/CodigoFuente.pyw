...
# Obtener el identificador de la ventana actual (consola de Windows)
...
help_button = ctk.CTkButton(
    ...
    image=help_icon,
    text="",
    command=lambda: messagebox.showinfo("Ayuda - ENK Generador de Unifilares",
                                        "Bienvenido al ENK Generador de Unifilares. \n\nSi tiene alguna duda, por favor consulte el manual de uso ubicado en la carpeta de instalación del programa, en la ruta:\n\nENK_Generador_Unifilares\\docs\\ayuda"),
    fg_color="transparent",  # Color de fondo del botón
    hover_color="grey",  # Color al pasar el ratón
    width=30,
    height=30,
    border_width=0
)
